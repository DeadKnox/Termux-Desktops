...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktop/main/scripts/startalpine.sh \
  -O ~/startalpine.sh
...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktop/main/scripts/startalpine-adreno.sh \
  -O ~/startalpine.sh
chmod +x ~/startalpine.sh
```
