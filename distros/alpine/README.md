...
```bash
wget https://raw.githubusercontent.com/ryuV2/Termux-Desktops/main/scripts/startalpine.sh \
  -O ~/startalpine.sh
...
```bash
wget https://raw.githubusercontent.com/ryuV2/Termux-Desktops/main/scripts/startalpine-adreno.sh \
  -O ~/startalpine.sh
chmod +x ~/startalpine.sh
```
