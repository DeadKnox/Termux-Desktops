...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktops/main/scripts/startarch.sh \
  -O ~/startarch.sh
...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktops/main/scripts/startarch-adreno.sh \
  -O ~/startarch.sh
chmod +x ~/startarch.sh
```
