...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktops/main/scripts/startubuntu.sh \
  -O ~/startubuntu.sh
...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktops/main/scripts/startubuntu-adreno.sh \
  -O ~/startubuntu.sh
chmod +x ~/startubuntu.sh
```
