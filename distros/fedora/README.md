...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktopsmain/scripts/startfedora.sh \
  -O ~/startfedora.sh
...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktopsmain/scripts/startfedora-adreno.sh \
  -O ~/startfedora.sh
chmod +x ~/startfedora.sh
```
