...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktops/main/scripts/startkali.sh \
  -O ~/startkali.sh
...
```bash
wget https://raw.githubusercontent.com/DeadKnox/Termux-Desktops/main/scripts/startkali-adreno.sh \
  -O ~/startkali.sh
chmod +x ~/startkali.sh
```
